...
// An asignment :
1.  WRITE A GET API TO GET THE LIST OF ALL THE "vaccination sessions by district id" for any given district id and for any given date  - apisetu.gov.in
...
my key - //0f8c9ae77d25bc9fbdf62bfd04b8dec3

Create API's to do each of the following:
                    - get weather of London from http://api.openweathermap.org/data/2.5/weather?q=London&appid=0f8c9ae77d25bc9fbdf62bfd04b8dec3  (NOTE: must use HTTP infront of the url else axios will attempt to hit localhost and give error  ..also use HTTP only and not HTTPS)
